...
public abstract class Tetronimo extends ShapeGroup
{
    ...
    public int[][] getRLocation(){
        ...
        xLoc = r1.getXLocation();
        yLoc = r1.getYLocation();
        rArray[0][0] = xLoc;
        rArray[0][1] = yLoc;

        xLoc = r2.getXLocation();
        yLoc = r2.getYLocation();
        rArray[1][0] = xLoc;
        rArray[1][1] = yLoc;

        xLoc = r3.getXLocation();
        yLoc = r3.getYLocation();
        rArray[2][0] = xLoc;
        rArray[2][1] = yLoc;

        xLoc = r4.getXLocation();
        yLoc = r4.getYLocation();
        rArray[3][0] = xLoc;
        rArray[3][1] = yLoc;
